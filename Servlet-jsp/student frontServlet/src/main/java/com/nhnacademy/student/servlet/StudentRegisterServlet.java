...
//        rd.forward(req,resp);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Gender gender= null;
        log.error("Gender:{}",req.getParameter("group"));
        if(Objects.nonNull(req.getParameter("group"))) {
            gender = Gender.valueOf(req.getParameter("group"));
        }
        Integer age=null;
        log.error("age:{}",req.getParameter("age"));
