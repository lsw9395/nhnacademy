...
public class JsonUserRepository implements UserRepository {
    ...
    //json file 저장 경로
    private static final String JSON_FILE_PATH="/Users/iseong-un/Downloads/postlist_3_test/src/json/user.json";//맥용
    //private static final String JSON_FILE_PATH="C:\\Users\\이성운\\Desktop\\postlist_3_test\\src\\json\\user.json";//윈도우용
